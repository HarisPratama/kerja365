        ...
        <>
            <View style={{ padding: 20 }} >
                ...
                {job?.targets?.length > 0 && (
                    <View style={{ paddingBottom: 50, marginTop: 10 }} >
                        <View
                            style={{
                ...
                {!job?.targets && (
                    <TouchableOpacity
                        onPress={fadeIn}
                        style={{
                            marginTop: 10, padding: 20, width: 200, flexDirection: 'row', backgroundColor: '#2ecc71', borderRadius: 11
                        }}
                    >
                        <Text style={{ fontFamily: 'DMSans-Bold', color: '#ffff' }} >Start Project</Text>
                        <Text style={{ marginLeft: 10, color: '#ffff', fontFamily: 'DMSans-Bold', fontSize: 18 }} >{'>>'}</Text>
                    </TouchableOpacity>
                )}
            </View>
        </>
